        ...
        <div className="flex items-center justify-between gap-2 shrink-0 sm:justify-normal">
          <div className="flex items-center gap-2">
            ...
            <div className="relative">
              ...
              <svg className="pointer-events-none absolute right-2.5 top-1/2 h-3.5 w-3.5 -translate-y-1/2" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" style={{ color: 'var(--m-muted)' }}>
                <path d="m6 9 6 6 6-6" />
              </svg>
            </div>
          </div>
