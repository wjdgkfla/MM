...
export function SubNavRail({
  ...
  return (
    ...
    >
      <div className="mx-auto flex h-[54px] max-w-[1280px] items-center gap-3 px-6">
        ...
        {/* Count (right edge) */}
        {!loading && (
          <p className="hidden shrink-0 items-center gap-1.5 text-[12px] sm:flex" style={{ color: 'var(--m-muted)' }}>
